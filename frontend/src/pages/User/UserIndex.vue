  ...
  <q-page>
      ...
      <q-dialog v-model="showDialogDeleteUsuario" persistent>
          ...
          >
              ...
              <q-card-actions class="row text-blue-10">
                  <q-space />
                  <q-btn @click="showDialogDeleteUsuario = false" outline style=" width: 150px;" label="VOLTAR" />
                  <q-btn @click="confirmDeleteUsuario" style=" width: 150px;" color="blue-10" label="Confirmar" />
              </q-card-actions>
          </q-card>
      </q-dialog>
      ...
      <div class="q-pa-xl">
          ...
          >
              <template v-slot:body="props">
                  <q-tr :props="props">
                      ...
                      <q-td key="actions" :props="props">
                          <q-btn color="blue-10" class="q-mr-md" size="sm" round icon="mode_edit" @click="$router.push(`/users/edit/${props.row.id}`)"><q-tooltip> Editar Usuário </q-tooltip></q-btn>
                          <q-btn color="blue-10" class="q-mr-md" size="sm" round icon="visibility" @click="$router.push(`/users/profile/${props.row.id}`)"><q-tooltip> Visualizar Usuário </q-tooltip></q-btn>
                          <q-btn color="blue-10" class="q-mr-md" size="sm" round icon="delete" @click="openDialogDeleteUsuario(props.row)"><q-tooltip> Deletar Usuário </q-tooltip></q-btn>
              ...
              <template v-slot:top>
                  ...
                  <q-space />
                  <q-btn color="blue-10" label="NOVO USUÁRIO"  @click="$router.push('/users/create')"/>
              </template>
          </q-table>
      </div>
  </q-page>
